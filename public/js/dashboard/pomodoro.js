$(document).ready(function() {
    ...
    setInterval(function() {
            ...
            if ((6 * d.getMinutes() + d.getSeconds() / 10 >= endPom - 0.2 && 6 * d.getMinutes() + d.getSeconds() / 10 <= endPom + 0.2) && pomRunning) {
    ...
    function updateTimeParagraph() {
            ...
            $("#workTime").html("Dibutuhkan sekitar" + hourString + isAnd + minuteString + "untuk menyelesaikannya");
    }
