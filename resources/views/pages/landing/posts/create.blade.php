                ...
                <div class="pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8">
                    <div class="w-full max-w-lg  mx-auto">
                        <div class="card rounded-lg shadow">
                            ...
                            <form method="POST" class="card-body bg-white p-6"
                                action="{{ route('posts.store') }}">
                                @csrf
                                ...
                                <textarea id="content" class="form-input w-full @error('content') border-red-500 @enderror" name="content" required>{{ old('content') }}</textarea>
                                @error('content')
